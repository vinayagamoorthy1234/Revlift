				...
				<div class="col-sm-6">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<form method="POST" action="<?php echo e(route('admin.billing.store')); ?>" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										?>
										<?php echo e(Form::select('customer', $list, '', ['id'=>'customer', 'class'=>'form-control'])); ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<?php echo e(Form::text('email', '', ['id'=>'email', 'class'=>'form-control'])); ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<?php echo e(Form::text('phone', '', ['id'=>'phone', 'class'=>'form-control'])); ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<?php echo e(Form::text('city', '', ['id'=>'city', 'class'=>'form-control'])); ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<?php echo e(Form::text('state', '', ['id'=>'state', 'class'=>'form-control'])); ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<?php echo e(Form::text('zip_code', '', ['id'=>'zip_code', 'class'=>'form-control'])); ?>

									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
										<?php echo e(Form::submit('Create Billing Office', ['id'=>'submit', 'class'=>'btn btn-primary pull-right'])); ?>
