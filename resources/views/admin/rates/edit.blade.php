			...
			<div class="row">
				<div class="col-sm-12">
					...
					<ol class="breadcrumb pull-right">
						...
						<li><a href="{{route('admin.rates.show', ['id'=>$rate->id])}}">{{$rate->name}}</a></li>
				...
				<div class="col-sm-12">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							@include('errors.form')
							<form method="POST" action="{{route('admin.rates.update', ['id'=>$rate->id])}}" class="form-horizontal">
								{{method_field('patch')}}
								{{csrf_field()}}
								<div class="form-group">
									<label for="name" class="col-sm-3 control-label">Nickname</label>
									<div class="col-sm-9">
										{{Form::text('name', $rate->name, ['id'=>'name', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										?>
										{{Form::select('billing_office', $list, $rate->billing_office_id, ['id'=>'billing_office', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="chain_up_fee" class="col-sm-3 control-label">Chain Up Fee</label>
									<div class="col-sm-9">
										{{Form::text('chain_up_fee', $rate->chain_up_fee, ['id'=>'chain_up_fee', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="chain_up_pay" class="col-sm-3 control-label">Chain Up Driver Pay</label>
									<div class="col-sm-9">
										{{Form::text('chain_up_pay', $rate->chain_up_pay, ['id'=>'chain_up_pay', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="demm_fee" class="col-sm-3 control-label">Demurrage Fee</label>
									<div class="col-sm-9">
										{{Form::text('demm_fee', $rate->demm_fee, ['id'=>'demm_fee', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="nc_demm_hrs" class="col-sm-3 control-label">No Charge Demurrage Hrs</label>
									<div class="col-sm-9">
										{{Form::text('nc_demm_hrs', $rate->nc_demm_hrs, ['id'=>'nc_demm_hrs', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="divert_fee" class="col-sm-3 control-label">Divert Fee</label>
									<div class="col-sm-9">
										{{Form::text('divert_fee', $rate->divert_fee, ['id'=>'divert_fee', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="reject_fee" class="col-sm-3 control-label">Reject Fee</label>
									<div class="col-sm-9">
										{{Form::text('reject_fee', $rate->reject_fee, ['id'=>'reject_fee', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="split_fee" class="col-sm-3 control-label">Split Fee</label>
									<div class="col-sm-9">
										{{Form::text('split_fee', $rate->split_fee, ['id'=>'split_fee', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="masking_fee" class="col-sm-3 control-label">Masking Fee</label>
									<div class="col-sm-9">
										{{Form::text('masking_fee', $rate->masking_fee, ['id'=>'masking_fee', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="fsc_formula" class="col-sm-3 control-label">Fuel Surcharge Fraction</label>
									<div class="col-sm-9">
										{{Form::text('fsc_formula', $rate->fsc_formula, ['id'=>'fsc_formula', 'class'=>'form-control'])}}
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										{{Form::text('load_barrels', $rate->load_barrels, ['id'=>'load_barrels', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="load_time" class="col-sm-3 control-label">Load Time</label>
									<div class="col-sm-9">
										{{Form::text('load_time', $rate->load_time, ['id'=>'load_time', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="min_bbls" class="col-sm-3 control-label">Minimum Barrels</label>
									<div class="col-sm-9">
										{{Form::text('min_bbls', $rate->min_bbls, ['id'=>'min_bbls', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="discount" class="col-sm-3 control-label">Discount</label>
									<div class="col-sm-9">
										{{Form::text('discount', $rate->discount, ['id'=>'discount', 'class'=>'form-control'])}}
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										{{Form::checkbox('is_default', $rate->is_default, ['id'=>'is_default', 'class'=>'form-control'])}}										
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
