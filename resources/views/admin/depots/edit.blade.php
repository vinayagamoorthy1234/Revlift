...
@section('content')
	...
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Edit Depot</h4>
					<ol class="breadcrumb pull-right">
						<li><a href="{{route('dashboard')}}">Anyware</a></li>
						<li><a href="{{route('admin.depots.index')}}">Depots</a></li>
						<li><a href="{{route('admin.depots.show', ['id'=>$depot->id])}}">Depot #{{$depot->code}}</a></li>
				...
				<div class="col-sm-6">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							@include('errors.form')
							<form method="POST" action="{{route('admin.depots.update', ['id'=>$depot->id])}}" class="form-horizontal">
								{{method_field('patch')}}
								{{csrf_field()}}
								<div class="form-group">
									<label for="code" class="col-sm-3 control-label">Code</label>
									<div class="col-sm-9">
										{{Form::text('code', $depot->code, ['id'=>'code', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="name" class="col-sm-3 control-label">Name</label>
									<div class="col-sm-9">
										{{Form::text('name', $depot->name, ['id'=>'name', 'class'=>'form-control'])}}
									</div>
								</div>
								<br />
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										{{Form::text('latitude', $depot->latitude, ['id'=>'latitude', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="longitude" class="col-sm-3 control-label">Longitude</label>
									<div class="col-sm-9">
										{{Form::text('longitude', $depot->longitude, ['id'=>'longitude', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
