...
@section('content')
	...
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Edit Billing Office</h4>
					<ol class="breadcrumb pull-right">
						<li><a href="{{route('dashboard')}}">Anyware</a></li>
						<li><a href="{{route('admin.billing.index')}}">Billing Offices</a></li>
						<li><a href="{{route('admin.billing.show', ['id'=>$office->id])}}">{{$office->name}}</a></li>
				...
				<div class="col-sm-6">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							@include('errors.form')
							<form method="POST" action="{{route('admin.billing.update', ['id'=>$office->id])}}" class="form-horizontal">
								{{method_field('patch')}}
								{{csrf_field()}}
								<div class="form-group">
									<label for="name" class="col-sm-3 control-label">Office Name</label>
									<div class="col-sm-9">
										{{Form::text('name', $office->name, ['id'=>'name', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="email" class="col-sm-3 control-label">Email</label>
									<div class="col-sm-9">
										{{Form::text('email', $office->email, ['id'=>'email', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="phone" class="col-sm-3 control-label">Phone</label>
									<div class="col-sm-9">
										{{Form::text('phone', $office->phone, ['id'=>'phone', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="address" class="col-sm-3 control-label">Address</label>
									<div class="col-sm-9">
										{{Form::text('address', $office->address, ['id'=>'address', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="city" class="col-sm-3 control-label">City</label>
									<div class="col-sm-9">
										{{Form::text('city', $office->city, ['id'=>'city', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="state" class="col-sm-3 control-label">State</label>
									<div class="col-sm-9">
										{{Form::text('state', $office->state, ['id'=>'state', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="zip_code" class="col-sm-3 control-label">Zip Code</label>
									<div class="col-sm-9">
										{{Form::text('zip_code', $office->zip_code, ['id'=>'zip_code', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
