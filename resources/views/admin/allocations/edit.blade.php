...
@section('content')
	...
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Edit Allocation</h4>
					<ol class="breadcrumb pull-right">
						<li><a href="{{route('dashboard')}}">Anyware</a></li>
						<li><a href="{{route('admin.allocations.index')}}">Allocations</a></li>
						<li><a href="{{route('admin.allocations.show', ['id'=>$allocation->id])}}">Allocation {{date('m/Y', strtotime($allocation->month_year))}} for {{$allocation->depot->name}}</a></li>
				...
				<div class="col-sm-6">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							@include('errors.form')
							<form method="POST" action="{{route('admin.allocations.update', ['id'=>$allocation->id])}}" class="form-horizontal">
								{{method_field('patch')}}
								{{csrf_field()}}
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										?>
										{{Form::select('depot_id', $depotList, $allocation->depot_id, ['id'=>'depot_id', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="bbls" class="col-sm-3 control-label">BBLs</label>
									<div class="col-sm-9">
										{{Form::text('bbls', $allocation->bbls, ['id'=>'bbls', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="bbls_revised" class="col-sm-3 control-label">BBLs Revised</label>
									<div class="col-sm-9">
										{{Form::text('bbls_revised', $allocation->bbls_revised, ['id'=>'bbls_revised', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="month_year" class="col-sm-3 control-label">Date of Allocation</label>
									<div class="col-sm-9">
										{{Form::date('month_year', date('Y-m-d', strtotime($allocation->month_year)), ['id'=>'month_year', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
