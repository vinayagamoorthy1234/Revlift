...
@section('content')
	...
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Edit Lease #{{$lease->number}}</h4>
					<ol class="breadcrumb pull-right">
						<li><a href="{{route('dashboard')}}">Anyware</a></li>
						<li><a href="{{route('admin.leases.index')}}">Leases</a></li>
						<li><a href="{{route('admin.leases.show', ['id'=>$lease->id])}}">Lease #{{$lease->number}}</a></li>
				...
				<div class="col-sm-6">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							@include('errors.form')
							<form method="POST" action="{{route('admin.leases.update', ['id'=>$lease->id])}}" class="form-horizontal">
								{{method_field('patch')}}
								{{csrf_field()}}
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										?>
										{{Form::select('operator_id', $list, $lease->operator_id, ['id'=>'operator_id', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-9">
										...
										?>
										{{Form::select('billing_office_id', $list, $lease->billing_office_id, ['id'=>'billing_office_id', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="number" class="col-sm-3 control-label">Lease Number</label>
									<div class="col-sm-9">
										{{Form::text('number', $lease->number, ['id'=>'number', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="name" class="col-sm-3 control-label">Lease Name</label>
									<div class="col-sm-9">
										{{Form::text('name', $lease->name, ['id'=>'name', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="county" class="col-sm-3 control-label">County</label>
									<div class="col-sm-9">
										{{Form::text('county', $lease->county, ['id'=>'county', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="state" class="col-sm-3 control-label">State</label>
									<div class="col-sm-9">
										{{Form::text('state', $lease->state, ['id'=>'state', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="section" class="col-sm-3 control-label">Section</label>
									<div class="col-sm-9">
										{{Form::text('section', $lease->section, ['id'=>'section', 'class'=>'form-control'])}}
									</div>
								</div>
								<br />
								<div class="form-group">
									...
									<div class="col-sm-9">
										{{Form::text('latitude', $lease->latitude, ['id'=>'latitude', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="longitude" class="col-sm-3 control-label">Longitude</label>
									<div class="col-sm-9">
										{{Form::text('longitude', $lease->longitude, ['id'=>'longitude', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
