...
@section('content')
	...
	<div class="content">
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-12">
					<h4 class="pull-left page-title">Add New Account</h4>
						...
						<div class="panel-body">
							...
							<form method="POST" action="{{route('admin.accounts.store')}}" class="form-horizontal">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										{{Form::text('contact_name', '', ['id'=>'contact_name', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="contact_email" class="col-sm-3 control-label">Contact Email</label>
									<div class="col-sm-9">
										{{Form::text('contact_email', '', ['id'=>'contact_email', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
									<label for="contact_phone" class="col-sm-3 control-label">Contact Phone</label>
									<div class="col-sm-9">
										{{Form::text('contact_phone', '', ['id'=>'contact_phone', 'class'=>'form-control'])}}
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<div class="col-sm-12">
										{{Form::submit('Create Account', ['id'=>'submit', 'class'=>'btn btn-primary pull-right'])}}
									</div>
								</div>
							</form>
						</div>
