			...
			<div class="left side-menu">
				<div class="sidebar-inner slimscrollleft">
					<div class="user-details">
						...
						<div class="user-info">
							<div class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">{{$currentUser->firstname.' '.$currentUser->lastname}} <span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li><a href="javascript:void(0)"><i class="md md-face-unlock"></i> Profile</a></li>
									<li><a href="javascript:void(0)"><i class="md md-settings"></i> Settings</a></li>
									<li><a href="{{url('/logout')}}"><i class="fa fa-power-off"></i> Logout</a></li>
					...
					<div id="sidebar-menu">
						...
						<ul>
							<li><a href="{{route('admin.accounts.index')}}" class="waves-effect waves-light {{ Request::segment(2)=='accounts' ? 'active':'' }}"><i class="fa fa-briefcase"></i><span> Accounts</span></a></li>
							<li><a href="{{url('admin/users')}}" class="waves-effect waves-light {{ Request::segment(2)=='users' ? 'active':'' }}"><i class="fa fa-users"></i><span> Users</span></a></li>
						</ul>
						<hr />
						@elseif($currentUser->role=='Owner' || $currentUser->role=='Manager')
						<ul>
							<li><a href="{{url('admin/users')}}" class="waves-effect waves-light {{ Request::segment(2)=='users' ? 'active':'' }}"><i class="fa fa-users"></i><span> Users</span></a></li>
						</ul>
						<hr />
						...
						<ul>
							<li>
								<a href="{{route('dashboard')}}" class="waves-effect waves-light {{ Request::segment(2)=='dashboard' ? 'active':'' }}"><i class="md md-home"></i><span> Dashboard</span></a>
							</li>
							<li>
								<a href="{{route('admin.devices.index')}}" class="waves-effect waves-light"><i class="md md-tablet-android"></i> <span>Manage Devices</span></a>
							</li>
							<li>
								<a href="{{route('admin.shipments.index')}}" class="waves-effect waves-light {{ Request::segment(2)=='shipments' ? 'active':'' }}"><i class="fa fa-archive"></i><span> Shipments</span></a>
							</li>
							<li class="has_sub">
								...
								<ul class="list-unstyled">
									<li><a href="{{route('admin.leases.index')}}" class="{{ Request::segment(2)=='leases' ? 'active':'' }}">View Leases</a></li>
									<li><a href="{{route('admin.tanks.index')}}" class="{{ Request::segment(2)=='tanks' ? 'active':'' }}">Tanks</a></li>
									<li><a href="{{route('admin.strappings.index')}}" class="{{ Request::segment(2)=='strappings' ? 'active':'' }}">Tank Strappings</a></li>
								</ul>
							</li>
							<li class="has_sub">
								...
								<ul class="list-unstyled">
									<li><a href="{{route('admin.depots.index')}}" class="{{ Request::segment(2)=='depots' ? 'active':'' }}">View Depots</a></li>
									<li><a href="{{route('admin.allocations.index')}}" class="{{ Request::segment(2)=='allocations' ? 'active':'' }}">Depot Allocations</a></li>
									<li><a href="{{route('admin.headers.index')}}" class="{{ Request::segment(2)=='headers' ? 'active':'' }}">Depot Headers</a></li>
								</ul>
							</li>
							<li class="has_sub">
								...
								<ul class="list-unstyled">
									<li><a href="{{route('admin.customers.index')}}" class="{{ Request::segment(2)=='customers' ? 'active':'' }}">View Customers</a></li>
									<li><a href="{{route('admin.billing.index')}}" class="{{ Request::segment(2)=='billing' ? 'active':'' }}">Billing Offices</a></li>
									<li><a href="{{route('admin.operators.index')}}" class="{{ Request::segment(2)=='operators' ? 'active':'' }}">Operators</a></li>
								</ul>
							</li>
							<li>
								<a href="{{route('admin.drivers.index')}}" class="waves-effect waves-light {{ Request::segment(2)=='drivers' ? 'active':'' }}"><i class="flaticon flaticon-steering-wheel"></i><span> Drivers</span></a>
							</li>
							<li>
								<a href="{{route('admin.trucks.index')}}" class="waves-effect waves-light {{ Request::segment(2)=='trucks' ? 'active':'' }}"><i class="flaticon flaticon-truck"></i><span> Trucks</span></a>
							</li>
							<li>
								<a href="{{route('admin.trailers.index')}}" class="waves-effect waves-light {{ Request::segment(2)=='trailers' ? 'active':'' }}"><i class="flaticon flaticon-freight"></i><span> Trailers</span></a>
							</li>
						</ul>
